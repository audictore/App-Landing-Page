...
const components = [
  ...
  '/components/black-landing/black-landing.html',
  '/components/destinations/destinations-text.html',
  '/components/destinations/destinations-cards.html',
  '/components/destinations/destinations-button.html',
]
